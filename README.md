...
** Last update: 2025-04-02 02:36:05 UTC**
...
- Butler A, Darby C, Hao Y, Hartman A, Hoffman P, Molla G, Satija R
...
- Team TBD (2023). _BSgenome.Hsapiens.UCSC.hg38: Full genomic sequences
...
- Tan G, Polychronopoulos D, Lenhard B (2019). “CNEr: A toolkit for
...
- Morgan M (2024). _DirichletMultinomial: Dirichlet-Multinomial Mixture
...
- Iannone R (2024). _fontawesome: Easily Work with 'Font Awesome' Icons_.
...
- Helwig NE (2022). _ica: Independent Component Analysis_. R package
...
- Ooms J (2025). _magick: Advanced Graphics and Image-Processing in R_. R
...
- Johnson A, Baddeley A (2024). _polyclip: Polygon Clipping_. R package
...
- Loden J, Daeschler D, Rodola' G, Csárdi G (2025). _ps: List, Query,
...
- Boshnakov GN, Putman C (2024). _rbibutils: Read 'Bibtex' Files and
...
- Eddelbuettel D, Gillard M (2025). _RcppTOML: 'Rcpp' Bindings to Parser
...
- Smith M (2025). _rhdf5filters: HDF5 Compression Filters_.
...
- Qiu Y, Mei J (2024). _RSpectra: Solvers for Large-Scale Eigenvalue and
...
- Kulichova T, Kratochvil M (2023). _scattermore: Scatterplots with More
Points_. R package version 1.2,
<https://CRAN.R-project.org/package=scattermore>.

- Yu G (2024). _scatterpie: Scatter Pie Plot_. R package version 0.2.4,
<https://CRAN.R-project.org/package=scatterpie>.

- c("Hafemeister C, Satija R (2019). “Normalization and variance\nstabilization of single-cell RNA-seq data using regularized negative\nbinomial regression.” _Genome Biology_, *20*, 296.\ndoi:10.1186/s13059-019-1874-1\n<https://doi.org/10.1186/s13059-019-1874-1>,\n<https://doi.org/10.1186/s13059-019-1874-1>.", "Choudhary S, Satija R (2022). “Comparison and evaluation of statistical\nerror models for scRNA-seq.” _Genome Biology_, *23*, 20.\ndoi:10.1186/s13059-021-02584-9\n<https://doi.org/10.1186/s13059-021-02584-9>,\n<https://doi.org/10.1186/s13059-021-02584-9>."
)
...
- Bembom O, Ivanek R (2024). _seqLogo: Sequence logos for DNA sequence
alignments_. doi:10.18129/B9.bioc.seqLogo
<https://doi.org/10.18129/B9.bioc.seqLogo>, R package version 1.72.0,
<https://bioconductor.org/packages/seqLogo>.

- Wickham H, Chang W, Flight R, Müller K, Hester J (2025). _sessioninfo:
R Session Information_. R package version 1.2.3,
<https://CRAN.R-project.org/package=sessioninfo>.

- c("Hao Y, Stuart T, Kowalski MH, Choudhary S, Hoffman P, Hartman A,\nSrivastava A, Molla G, Madad S, Fernandez-Granda C, Satija R (2023).\n“Dictionary learning for integrative, multimodal and scalable\nsingle-cell analysis.” _Nature Biotechnology_.\ndoi:10.1038/s41587-023-01767-y\n<https://doi.org/10.1038/s41587-023-01767-y>,\n<https://doi.org/10.1038/s41587-023-01767-y>.", "Hao Y, Hao S, Andersen-Nissen E, III WMM, Zheng S, Butler A, Lee MJ,\nWilk AJ, Darby C, Zagar M, Hoffman P, Stoeckius M, Papalexi E, Mimitou\nEP, Jain J, Srivastava A, Stuart T, Fleming LB, Yeung B, Rogers AJ,\nMcElrath JM, Blish CA, Gottardo R, Smibert P, Satija R (2021).\n“Integrated analysis of multimodal single-cell data.” _Cell_.\ndoi:10.1016/j.cell.2021.04.048\n<https://doi.org/10.1016/j.cell.2021.04.048>,\n<https://doi.org/10.1016/j.cell.2021.04.048>.", 
"Stuart T, Butler A, Hoffman P, Hafemeister C, Papalexi E, III WMM, Hao\nY, Stoeckius M, Smibert P, Satija R (2019). “Comprehensive Integration\nof Single-Cell Data.” _Cell_, *177*, 1888-1902.\ndoi:10.1016/j.cell.2019.05.031\n<https://doi.org/10.1016/j.cell.2019.05.031>,\n<https://doi.org/10.1016/j.cell.2019.05.031>.", "Butler A, Hoffman P, Smibert P, Papalexi E, Satija R (2018).\n“Integrating single-cell transcriptomic data across different\nconditions, technologies, and species.” _Nature Biotechnology_, *36*,\n411-420. doi:10.1038/nbt.4096 <https://doi.org/10.1038/nbt.4096>,\n<https://doi.org/10.1038/nbt.4096>.", 
"Satija R, Farrell JA, Gennert D, Schier AF, Regev A (2015). “Spatial\nreconstruction of single-cell gene expression data.” _Nature\nBiotechnology_, *33*, 495-502. doi:10.1038/nbt.3192\n<https://doi.org/10.1038/nbt.3192>, <https://doi.org/10.1038/nbt.3192>.")

- Satija R, Hoffman P, Butler A (2025). _SeuratData: Install and Manage
Seurat Datasets_. R package version 0.2.2.9002, commit
3e51f44303069b64f5dc4d68e6a3d4a343f55c39,
<https://github.com/satijalab/seurat-data>.

- Hoffman P (2023). _SeuratDisk: Interfaces for HDF5-Based Single Cell
File Formats_. R package version 0.0.0.9021, commit
877d4e18ab38c686f5db54f8cd290274ccdbe295,
<https://github.com/mojaveazure/seurat-disk>.

- Hoffman P, Satija R, Collins D, Hao Y, Hartman A, Molla G, Butler A,
Stuart T (2024). _SeuratObject: Data Structures for Single Cell Data_.
R package version 5.0.2,
<https://CRAN.R-project.org/package=SeuratObject>.

- Butler A, Hoffman P, Satija R, Stuart T (2024). _SeuratWrappers:
Community-Provided Methods and Extensions for the Seurat Object_. R
package version 0.4.0, commit a1eb0d8b039ad6d5ef0ff1332fd8eb1c0c223553,
...
- Stuart T, Srivastava A, Madad S, Lareau C, Satija R (2021).
“Single-cell chromatin state analysis with Signac.” _Nature Methods_.
doi:10.1038/s41592-021-01282-5
<https://doi.org/10.1038/s41592-021-01282-5>,
https://doi.org/10.1038/s41592-021-01282-5.

- Amezquita R, Lun A, Becht E, Carey V, Carpp L, Geistlinger L, Marini F,
Rue-Albrecht K, Risso D, Soneson C, Waldron L, Pages H, Smith M, Huber
W, Morgan M, Gottardo R, Hicks S (2020). “Orchestrating single-cell
analysis with Bioconductor.” _Nature Methods_, *17*, 137-145.
<https://www.nature.com/articles/s41592-019-0654-x>.

- Balamuta J, van den Berg T (2021). _sitmo: Parallel Pseudo Random
Number Generator (PPRNG) 'sitmo' Header Files_. R package version
2.0.2, <https://CRAN.R-project.org/package=sitmo>.

- Azzalini AA (2023). _The R package \texttt{sn}: The skew-normal and
related distributions such as the skew-$t$ and the SUN (version
2.1.1)._. Home page: <http://azzalini.stat.unipd.it/SN/>,
<https://cran.r-project.org/package=sn>.

- Butts CT (2024). _sna: Tools for Social Network Analysis_. R package
version 2.8, <https://CRAN.R-project.org/package=sna>.

- Tierney L, Rossini AJ, Li N, Sevcikova H (2021). _snow: Simple Network
of Workstations_. R package version 0.4-4,
<https://CRAN.R-project.org/package=snow>.

- Young MD, Behjati S (2020). “SoupX removes ambient RNA contamination
from droplet-based single-cell RNA sequencing data.” _GigaScience_.
doi:10.1093/gigascience/giaa151
<https://doi.org/10.1093/gigascience/giaa151>.

- Ushey K (2023). _sourcetools: Tools for Reading, Tokenizing and Parsing
R Code_. R package version 0.1.7-1,
<https://CRAN.R-project.org/package=sourcetools>.

- c("Pebesma E, Bivand R (2005). “Classes and methods for spatial data in\nR.” _R News_, *5*(2), 9-13. <https://CRAN.R-project.org/doc/Rnews/>.", "Bivand R, Pebesma E, Gomez-Rubio V (2013). _Applied spatial data\nanalysis with R, Second edition_. Springer, NY.\n<https://asdar-book.org/>.")

- c("Furrer R, Flury R, Gerber F (2024). _spam: SPArse Matrix_.\ndoi:10.32614/CRAN.package.spam\n<https://doi.org/10.32614/CRAN.package.spam>, R package version 2.11-1,\n<https://CRAN.R-project.org/package=spam>.", "Furrer R, Sain SR (2010). “spam: A Sparse Matrix R Package with\nEmphasis on MCMC Methods for Gaussian Markov Random Fields.” _Journal\nof Statistical Software_, *36*(10), 1-25. doi:10.18637/jss.v036.i10\n<https://doi.org/10.18637/jss.v036.i10>.", "Gerber F, Furrer R (2015). “Pitfalls in the Implementation of Bayesian\nHierarchical Modeling of Areal Count Data: An Illustration Using BYM\nand Leroux Models.” _Journal of Statistical Software, Code Snippets_,\n*63*(1), 1-32. doi:10.18637/jss.v063.c01\n<https://doi.org/10.18637/jss.v063.c01>.", 
"Gerber F, Moesinger K, Furrer R (2017). “Extending R packages to\nsupport 64-bit compiled code: An illustration with spam64 and GIMMS\nNDVI3g data.” _Computer & Geoscience_, *104*, 109-119. ISSN 0098-3004,\ndoi:10.1016/j.cageo.2016.11.015\n<https://doi.org/10.1016/j.cageo.2016.11.015>.")

- Pagès H (2025). _SparseArray: High-performance sparse data
representation and manipulation in R_. doi:10.18129/B9.bioc.SparseArray
<https://doi.org/10.18129/B9.bioc.SparseArray>, R package version
1.6.2, <https://bioconductor.org/packages/SparseArray>.

- Koenker R (2024). _SparseM: Sparse Linear Algebra_. R package version
1.84-2, <https://CRAN.R-project.org/package=SparseM>.

- Ahlmann-Eltze C (2024). _sparseMatrixStats: Summary Statistics for Rows
and Columns of Sparse Matrices_. doi:10.18129/B9.bioc.sparseMatrixStats
<https://doi.org/10.18129/B9.bioc.sparseMatrixStats>, R package version
1.18.0, <https://bioconductor.org/packages/sparseMatrixStats>.

- c("Baddeley A, Rubak E, Turner R (2015). _Spatial Point Patterns:\nMethodology and Applications with R_. Chapman and Hall/CRC Press,\nLondon. ISBN 9781482210200,\n<https://www.routledge.com/Spatial-Point-Patterns-Methodology-and-Applications-with-R/Baddeley-Rubak-Turner/p/book/9781482210200/>.", "Baddeley A, Turner R, Mateu J, Bevan A (2013). “Hybrids of Gibbs Point\nProcess Models and Their Implementation.” _Journal of Statistical\nSoftware_, *55*(11), 1-43. doi:10.18637/jss.v055.i11\n<https://doi.org/10.18637/jss.v055.i11>.", 
...
- Baddeley A, Turner R, Rubak E (2025). _spatstat.utils: Utility
Functions for 'spatstat'_. R package version 3.1-3,
<https://CRAN.R-project.org/package=spatstat.utils>.

- c("Giner G, Smyth GK (2016). “statmod: probability calculations for the\ninverse Gaussian distribution.” _R Journal_, *8*(1), 339-351.", "Phipson B, Smyth GK (2010). “Permutation p-values should never be zero:\ncalculating exact p-values when permutations are randomly drawn.”\n_Statistical Applications in Genetics and Molecular Biology_, *9*(1),\nArticle 39.", "Hu Y, Smyth GK (2009). “ELDA: extreme limiting dilution analysis for\ncomparing depleted and enriched populations in stem cell and other\nassays.” _Journal of Immunological Methods_, *347*(1), 70-78.", 
"Smyth GK (2005). “Optimization and nonlinear equations.” _Encyclopedia\nof Biostatistics_, 3088-3095.", "Smyth GK (2005). “Numerical integration.” _Encyclopedia of\nBiostatistics_, 3088-3095.", "Smyth GK (2002). “An efficient algorithm for REML in heteroscedastic\nregression.” _Journal of Computational and Graphical Statistics_, *11*,\n836-847.", "Dunn PK, Smyth GK (1996). “Randomized quantile residuals.” _J. Comput.\nGraph. Statist_, *5*, 236-244.")

- Krivitsky PN (2024). _statnet.common: Common R Scripts and Utilities
Used by the Statnet Project Software_. The Statnet Project
(<https://statnet.org>). R package version 4.11.0,
...
- Müller K, Walthert L (2024). _styler: Non-Invasive Pretty Printing of R
Code_. R package version 1.10.3,
<https://CRAN.R-project.org/package=styler>.

- Morgan M, Obenchain V, Hester J, Pagès H (2024). _SummarizedExperiment:
A container (S4 class) for matrix-like assays_.
...
- Ooms J (2024). _sys: Powerful and Reliable Tools for Running System
Commands in R_. R package version 3.4.3,
<https://CRAN.R-project.org/package=sys>.

- Pedersen T, Ooms J, Govett D (2025). _systemfonts: System Native Font
Finding_. R package version 1.2.1,
<https://CRAN.R-project.org/package=systemfonts>.

- Rougier J (2012). _tensor: Tensor product of arrays_. R package version
1.5, <https://CRAN.R-project.org/package=tensor>.

- Wickham H (2011). “testthat: Get Started with Testing.” _The R
Journal_, *3*, 5-10.
<https://journal.r-project.org/archive/2011-1/RJournal_2011-1_Wickham.pdf>.

- Pedersen T (2025). _textshaping: Bindings to the 'HarfBuzz' and
'Fribidi' Libraries for Text Shaping_. R package version 1.0.0,
<https://CRAN.R-project.org/package=textshaping>.

- Tan G, Lenhard B (2016). “TFBSTools: an R/Bioconductor package for
transcription factor binding site analysis.” _Bioinformatics_, *32*,
1555-1556. doi:10.1093/bioinformatics/btw024
<https://doi.org/10.1093/bioinformatics/btw024>,
<http://bioinformatics.oxfordjournals.org/content/32/10/1555>.

- Zhang H, Wu Z (2018). _TFisher: Optimal Thresholding Fisher's P-Value
Combination Method_. R package version 0.2.0,
<https://CRAN.R-project.org/package=TFisher>.

- Tan G (2022). _TFMPvalue: Efficient and Accurate P-Value Computation
for Position Weight Matrices_. R package version 0.0.9,
<https://CRAN.R-project.org/package=TFMPvalue>.

- Hothorn T (2025). _TH.data: TH's Data Archive_. R package version
1.1-3, <https://CRAN.R-project.org/package=TH.data>.
...
- Henry L, Wickham H (2024). _tidyselect: Select from a Set of Strings_.
R package version 1.2.1,
<https://CRAN.R-project.org/package=tidyselect>.

- Yu G (2022). _Data Integration, Manipulation and Visualization of
Phylogenetic Treess_, 1st edition edition. Chapman and Hall/CRC.
doi:10.1201/9781003279242 <https://doi.org/10.1201/9781003279242>,
<https://www.amazon.com/Integration-Manipulation-Visualization-Phylogenetic-Computational-ebook/dp/B0B5NLZR1Z/>.

- c("Xie Y (2025). _tinytex: Helper Functions to Install and Maintain TeX\nLive, and Compile LaTeX Documents_. R package version 0.56,\n<https://github.com/rstudio/tinytex>.", "Xie Y (2019). “TinyTeX: A lightweight, cross-platform, and\neasy-to-maintain LaTeX distribution based on TeX Live.” _TUGboat_,\n*40*(1), 30-32. <https://tug.org/TUGboat/Contents/contents40-1.html>.")

- Li J (2019). _tmcn: A Text Mining Toolkit for Chinese_. R package
version 0.2-13, <https://CRAN.R-project.org/package=tmcn>.

- c("Yu G (2022). _Data Integration, Manipulation and Visualization of\nPhylogenetic Treess_, 1st edition edition. Chapman and Hall/CRC.\n<https://www.amazon.com/Integration-Manipulation-Visualization-Phylogenetic-Computational-ebook/dp/B0B5NLZR1Z/>.", "Wang L, Lam T, Xu S, Dai Z, Zhou L, Feng T, Guo P, Dunn C, Jones B,\nBradley T, Zhu H, Guan Y, Jiang Y, Yu G (2020). “treeio: an R package\nfor phylogenetic tree input and output with richly annotated and\nassociated data.” _Molecular Biology and Evolution_, *37*, 599-603.\ndoi:10.1093/molbev/msz240 <https://doi.org/10.1093/molbev/msz240>."
)

- Pedersen T (2024). _tweenr: Interpolate Data for Smooth Animations_. R
package version 2.0.3, <https://CRAN.R-project.org/package=tweenr>.

- Vaughan D (2025). _tzdb: Time Zone Database Information_. R package
version 0.5.0, <https://CRAN.R-project.org/package=tzdb>.

- Pagès H (2024). _UCSC.utils: Low-level utilities to retrieve data from
the UCSC Genome Browser_. doi:10.18129/B9.bioc.UCSC.utils
<https://doi.org/10.18129/B9.bioc.UCSC.utils>, R package version 1.2.0,
...
- Wickham H, Bryan J, Barrett M, Teucher A (2024). _usethis: Automate
Package and Project Setup_. R package version 3.1.0,
...
UUIDs_. R package version 1.2-1,
<https://CRAN.R-project.org/package=uuid>.

- Melville J (2025). _uwot: The Uniform Manifold Approximation and
Projection (UMAP) Method for Dimensionality Reduction_. R package
version 0.2.3, <https://CRAN.R-project.org/package=uwot>.

- Wickham H, Henry L, Vaughan D (2023). _vctrs: Vector Helpers_. R
package version 0.6.5, <https://CRAN.R-project.org/package=vctrs>.

- Chen H (2022). _VennDiagram: Generate High-Resolution Venn and Euler
Plots_. R package version 1.7.3,
<https://CRAN.R-project.org/package=VennDiagram>.

- Sherrill-Mix S, Clarke E (2023). _vipor: Plot Categorical Data Using
Quasirandom Noise and Density Estimates_. R package version 0.4.7,
...
- Garnier, Simon, Ross, Noam, Rudis, Robert, Camargo, Pedro A, Sciaini,
Marco, Scherer, Cédric (2023). _viridis(Lite) - Colorblind-Friendly
Color Maps for R_. doi:10.5281/zenodo.4678327
<https://doi.org/10.5281/zenodo.4678327>, viridisLite package version
0.4.2, <https://sjmgarnier.github.io/viridis/>.

- Hester J, Wickham H, Bryan J (2023). _vroom: Read and Write Rectangular
Text Data Quickly_. R package version 1.6.5,
<https://CRAN.R-project.org/package=vroom>.

- Wickham H (2024). _waldo: Find Differences Between R Objects_. R
package version 0.6.1, <https://CRAN.R-project.org/package=waldo>.
...
version 3.0.2, <https://CRAN.R-project.org/package=withr>.

- Xie Y (2025). _xfun: Supporting Functions for Packages Maintained by
'Yihui Xie'_. R package version 0.51,
<https://CRAN.R-project.org/package=xfun>.

- Temple Lang D (2025). _XML: Tools for Parsing and Generating XML Within
R and S-Plus_. R package version 3.99-0.18,
<https://CRAN.R-project.org/package=XML>.

- Wickham H, Hester J, Ooms J (2025). _xml2: Parse XML_. R package
version 1.3.8, <https://CRAN.R-project.org/package=xml2>.
...
- Csárdi G, Boudra F, Dieter R, Krammer K, White J (2024). _xopen: Open
System Files, 'URLs', Anything_. R package version 1.0.1,
...
<https://doi.org/10.18129/B9.bioc.XVector>, R package version 0.46.0,
<https://bioconductor.org/packages/XVector>.

- Garbett SP, Stephens J, Simonov K, Xie Y, Dong Z, Wickham H, Horner J,
reikoch, Beasley W, O'Connor B, Warnes GR, Quinn M, Kamvar ZN, Gao C
(2024). _yaml: Methods to Convert R Data to YAML and Back_. R package
version 2.3.10, <https://CRAN.R-project.org/package=yaml>.

- Yu G (2025). _yulab.utils: Supporting Functions for Packages Maintained
by 'YuLab-SMU'_. R package version 0.2.0,
<https://CRAN.R-project.org/package=yulab.utils>.

- Csárdi G (2025). _zip: Cross-Platform 'zip' Compression_. R package
version 2.3.2, <https://CRAN.R-project.org/package=zip>.

- Morgan M (2024). _zlibbioc: An R packaged zlib-1.2.5_.
doi:10.18129/B9.bioc.zlibbioc
<https://doi.org/10.18129/B9.bioc.zlibbioc>, R package version 1.52.0,
...
- c("Angelo Canty, B. D. Ripley (2024). _boot: Bootstrap R (S-Plus)\nFunctions_. R package version 1.3-31.", "A. C. Davison, D. V. Hinkley (1997). _Bootstrap Methods and Their\nApplications_. Cambridge University Press, Cambridge. ISBN\n0-521-57391-2, <doi:10.1017/CBO9780511802843>.")

- Venables WN, Ripley BD (2002). _Modern Applied Statistics with S_,
Fourth edition. Springer, New York. ISBN 0-387-95457-0,
<https://www.stats.ox.ac.uk/pub/MASS4/>.

- Maechler M, Rousseeuw P, Struyf A, Hubert M, Hornik K (2025). _cluster:
Cluster Analysis Basics and Extensions_. R package version 2.1.8.1 -
For new features, see the 'NEWS' and the 'Changelog' file in the
package source), <https://CRAN.R-project.org/package=cluster>.

- Tierney L (2023). _codetools: Code Analysis Tools for R_. R package
version 0.2-19, <https://CRAN.R-project.org/package=codetools>.
...
- R Core Team (2025). _foreign: Read Data Stored by 'Minitab', 'S',
'SAS', 'SPSS', 'Stata', 'Systat', 'Weka', 'dBase', ..._. R package
version 0.8-88, <https://CRAN.R-project.org/package=foreign>.
...
- Wand M (2025). _KernSmooth: Functions for Kernel Smoothing Supporting
Wand & Jones (1995)_. R package version 2.23-26,
...
- Bates D, Maechler M, Jagan M (2025). _Matrix: Sparse and Dense Matrix
Classes and Methods_. R package version 1.7-3,
...
- c("Wood SN (2011). “Fast stable restricted maximum likelihood and marginal\nlikelihood estimation of semiparametric generalized linear models.”\n_Journal of the Royal Statistical Society (B)_, *73*(1), 3-36.", "Wood S, N., Pya, S\"afken B (2016). “Smoothing parameter and model\nselection for general smooth models (with discussion).” _Journal of the\nAmerican Statistical Association_, *111*, 1548-1575.", "Wood SN (2004). “Stable and efficient multiple smoothing parameter\nestimation for generalized additive models.” _Journal of the American\nStatistical Association_, *99*(467), 673-686.", 
"Wood S (2017). _Generalized Additive Models: An Introduction with R_, 2\nedition. Chapman and Hall/CRC.", "Wood SN (2003). “Thin-plate regression splines.” _Journal of the Royal\nStatistical Society (B)_, *65*(1), 95-114.")

- c("Pinheiro J, Bates D, R Core Team (2025). _nlme: Linear and Nonlinear\nMixed Effects Models_. R package version 3.1-167,\n<https://CRAN.R-project.org/package=nlme>.", "Pinheiro JC, Bates DM (2000). _Mixed-Effects Models in S and S-PLUS_.\nSpringer, New York. doi:10.1007/b98882\n<https://doi.org/10.1007/b98882>.")
...
- Therneau T, Atkinson B (2025). _rpart: Recursive Partitioning and
Regression Trees_. R package version 4.1.24,
...
- c("Therneau T (2024). _A Package for Survival Analysis in R_. R package\nversion 3.8-3, <https://CRAN.R-project.org/package=survival>.", "Terry M. Therneau, Patricia M. Grambsch (2000). _Modeling Survival\nData: Extending the Cox Model_. Springer, New York. ISBN 0-387-98784-3.")
